                ...
                <div class="landr">
                    ...
                    <ul id="personcenter" style="float:left;">
                        <li style="width:110px;"><a class="btn btn1" href="#" role="button">个人中心</a>
                                     <ul>
                                        <li><a href="${pageContext.request.contextPath}/userinfo.html">账号设置</a></li>
                                        <li><a href="${pageContext.request.contextPath}/personwork.html">我的菜单</a></li>
                                        <li><a href="${pageContext.request.contextPath}/myfriends.html">关注的好友</a></li>
