              ...
              操作                      
                             ...
                             <c:forEach items="${page.list}" var="menu" varStatus="loop">
                                      <tr>
                                        ...
                                        <td>
                                           <a href="${pageContext.request.contextPath}/admin/menu/disable?menuId=${menu.id}" method="post" 
                                           class="btn btn-info btn-xs edit"> 锁定</a>
                                           <a href="${pageContext.request.contextPath}/admin/menu/enable?menuId=${menu.id}" method="post" 
