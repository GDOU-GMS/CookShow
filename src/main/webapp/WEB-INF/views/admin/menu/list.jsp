            ...
            <div>
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="well with-header  with-footer" style="padding-bottom: 0px;" >
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/menu/query" method="post">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input name="name" class="form-control" style="width: 50%"
                        ...
                        <table id="click" class="table table-hover" >
                            ...
                            <c:forEach items="${page.list}" var="menu" varStatus="loop">
                                <tr>
                                    ...
                                    <td>
                                    <td>
                                        <c:if test="${menu.deleted eq 1}">
                                            已锁定
                                        </c:if>
                                        <c:if test="${menu.deleted eq 0}">
                                            未锁定
                                        </c:if>
                                    </td>
                                    <td>
                                        <c:if test="${menu.deleted eq 1}">
                                        <a href="${pageContext.request.contextPath}/admin/menu/enable?menuId=${menu.id}"
                                           method="post"
                                           class="btn btn-default btn-xs edit"> 解锁</a>
                                        </c:if>
                                        <c:if test="${menu.deleted eq 0}">
                                        <a href="${pageContext.request.contextPath}/admin/menu/disable?menuId=${menu.id}"
                                           method="post"
                                           class="btn btn-info btn-xs edit"> 锁定</a>
                                        </c:if>
                                        <a href="${pageContext.request.contextPath}/admin/menu/detail?menuId=${menu.id}"
