                    ...
                    <table id="click" class="table table-hover">
                        ...
                        <c:forEach items="${list}" var="list" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/admin/cookbook/disable?cookbookId=${list.id}"
                                       method="post"
                                       class="btn btn-info btn-xs edit"> 锁定</a>
                                    <a href="${pageContext.request.contextPath}/admin/cookbook/enable?cookbookId=${list.id}"
                                       method="post"
                                       class="btn btn-info btn-xs edit"> 解锁</a>
                                    <a href="${pageContext.request.contextPath}/admin/cookbook/detail?cookbookId=${list.id}"
